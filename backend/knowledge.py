...
BOOKING = (
    ...
    "from it.\n"
    "IF THEY GO QUIET WITH THE FORM OPEN. You may be nudged that the form is still empty. Each "
    "time, check in briefly and warmly, ask if they're still there and whether they've had a "
    "chance to enter it. If they answer or start typing, carry on. If they stay completely silent, "
    "the call wraps up on its own after a bit, so keep those check-ins short and friendly.\n"
