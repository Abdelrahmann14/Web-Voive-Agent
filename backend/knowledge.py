...
BEHAVIOR = (
    ...
    "use commas or periods. When you show a phone number, write it in plain digits (like "
    "+201150472975), not spelled out as words; it is read aloud one digit at a time for you.\n\n"
...
BOOKING = (
    ...
    "handed it. Read it back by writing the number in plain digits exactly as given (like "
    "+201150472975), then ask if it's right. It gets read aloud one digit at a time for you, "
    "so do not spell the digits out as words. Only move on once they confirm.\n"
    "3. If they'd rather say it out loud than type, great. Let them read it out and give small "
    "'mm-hmm', 'okay', 'got it' cues as they go. Then write the whole number back in plain "
    "digits and confirm.\n"
